...
const VIDEOSDK_SECRET = "62db5287e66364a8d97d73cfa1147fd92d4829bdc873648a09f9c640f366770a"; // VideoSDK secret key
...
app.post("/api/create-room", async (req, res) => {
  ...
  try {
    ...
    // 2. If no room exists, create persistent roomId
    if (!roomId) {
      roomId = `room_${userId}`;
    ...
    // 3. Generate host token (valid 24h)
